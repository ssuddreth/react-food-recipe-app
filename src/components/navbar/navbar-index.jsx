    ...
    return (
        <nav className="flex justify-between items-center py-8 container mx-auto flex-col lg:flex-row gap-5 lg:gap-0">
            <h2 className="text-2xl font-semibold">
                <NavLink to={"/"} onClick={() => window.location.reload()}>Food Recipe</NavLink>
            </h2>
            ...
            <ul className="flex gap-5">
                <li>
                    <NavLink to={'/'} onClick={() => window.location.reload()} className='text-black hover:text-gray-700 duration-300'>Home</NavLink>
                </li>
                <li>
